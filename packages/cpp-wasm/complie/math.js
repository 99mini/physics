...
/** not-@type {!BigUint64Array} */
    ...
    var _calculateVelocity = (Module['_calculateVelocity'] = makeInvalidEarlyAccess('_calculateVelocity'));
    ...
    function assignWasmExports(wasmExports) {
      ...
      Module['_calculateVelocity'] = _calculateVelocity = createExportWrapper('calculateVelocity', 2);
...
} else if (typeof define === 'function' && define['amd']) define([], () => MathModule);
